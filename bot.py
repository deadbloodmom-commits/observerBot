...
import logging
import os
import re  # <--- Для работы регулярных выражений
from datetime import datetime, timedelta
from dotenv import load_dotenv

import asyncpg
import psycopg2  # <--- Используем стандартный драйвер для psycopg2-binary
...
# Получаем токен из системных переменных хостинга или .env (используем BOT_TOKEN)
